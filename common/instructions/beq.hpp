#ifndef INSTRUCTION_BEQ_HPP
#define INSTRUCTION_BEQ_HPP

#include "../instruction.hpp"

class BeqInstruction : public Instruction {
public:    
    BeqInstruction(short, short, uint32, std::string, Section*,  std::unordered_map<std::string, Symbol*>&, short, JMPCondition);
