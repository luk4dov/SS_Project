...
public:
    Linker(std::vector<std::string> inputFiles, std::string outputFile, bool relocatable, std::unordered_map<std::string, uint32> sectionAddress, uint32 maxSectionAddress, std::string maxSectionName) :
